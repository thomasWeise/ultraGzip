...
public abstract class AbstractProcessBuilder<
    PT extends AbstractProcess,
    BT extends AbstractProcessBuilder<PT, BT>>
    implements Supplier<PT> {
   ...
   * @return this builder
   */
  public abstract BT writeStdOutTo(final Path dest,
   ...
   * @return this builder
   */
  public abstract BT writeStdErrTo(final Path dest,
      final boolean append);
