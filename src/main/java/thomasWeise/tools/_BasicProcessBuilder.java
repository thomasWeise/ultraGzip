 ...
 *          the builder type
 */
abstract class _BasicProcessBuilder<PT extends _BasicProcess,
    BT extends _BasicProcessBuilder<PT, BT>>
   ...
   * @return this builder
   */
  public abstract BT putEnvironmentPath(final String key,
      final Path value);
  ...
  public final BT
      setProcessCloser(final IProcessCloser<? super PT> closer) {
