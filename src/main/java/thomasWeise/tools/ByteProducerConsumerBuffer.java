...
/**
 * <p>
 * A producer/consumer buffer backed by a byte array, intended to
 * be used by different threads: A producer
 ...
 * {@link org.optimizationBenchmarking.utils.parallel.ProducerConsumerBuffer#readFromBuffer(Object, int, int)
 * reading} blocks until either data becomes available (has been
 * written) or the buffer is closed.
 * </p>
 */
